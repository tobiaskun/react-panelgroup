  ...
  render: function render() {
    ...
    for (var i = 0; i < initialChildren.length; i++) {
      ...
      if (i < initialChildren.length - 1) {
        newChildren.push(_react2.default.createElement(Divider, { borderColor: this.props.borderColor, key: "divider" + i, panelID: i, handleResize: this.handleResize, dividerWidth: this.props.spacing, direction: this.props.direction, showHandles: this.props.showHandles }));
      }
    }
